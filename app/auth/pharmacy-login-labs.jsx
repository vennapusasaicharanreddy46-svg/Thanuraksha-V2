...
try {
  ...
  LinearGradient = ({ children, colors, style, ...props }) => (
    <View
      style={[style, { backgroundColor: colors?.[0] || "#00d4ff" }]}
      {...props}
    >
      {children}
    </View>
...
const PharmacyLoginLabs = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      setLoading(true);
      console.log("Starting Google Sign-In for Lab Tests...");
      ...
      // Save pharmacy session data for labs
      ...
      console.log("Lab pharmacy session stored successfully");

      // Navigate to pharmacy dashboard - labs only
    ...
    <SafeAreaView style={styles.container}>
      ...
      <LinearGradient colors={["#0EA5E9", "#0369A1"]} style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerSubtitle}>Manage lab test orders</Text>
        </View>
      </LinearGradient>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.loginContainer}>
          ...
          <Text style={styles.loginNote}>
            Sign in with your lab account to manage test orders
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
...
export default PharmacyLoginLabs;
