...
try {
  ...
  LinearGradient = ({ children, colors, style, ...props }) => (
    <View
      style={[style, { backgroundColor: colors?.[0] || "#1dd1a1" }]}
      {...props}
    >
      {children}
    </View>
...
const PharmacyLoginDelivery = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      setLoading(true);
      console.log("Starting Google Sign-In for Delivery...");
      ...
      // Save pharmacy session data for delivery
      ...
      console.log("Delivery pharmacy session stored successfully");

      // Navigate to pharmacy dashboard - delivery only
    ...
    <SafeAreaView style={styles.container}>
      ...
      <LinearGradient colors={["#10B981", "#047857"]} style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerTitle}>Delivery Service</Text>
          <Text style={styles.headerSubtitle}>Manage medicine delivery</Text>
        </View>
      </LinearGradient>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.loginContainer}>
          ...
          <View style={styles.formSection}>
            ...
            {!isLogin && (
              <View style={styles.inputGroup}>
                <Text style={styles.label}>Delivery Partner Name</Text>
                <TextInput
                  style={styles.input}
                  placeholder="Enter your delivery name"
                  value={formData.name}
                  onChangeText={(text) =>
          ...
          <Text style={styles.loginNote}>
            Sign in with your delivery account to manage orders
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
...
export default PharmacyLoginDelivery;
